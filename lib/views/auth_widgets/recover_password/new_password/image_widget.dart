      ...
      children: [
        ...
        Positioned(
          ...
          child: Column(
            ...
            children: [
               Text(newPasswordWelcomeText1, style: Theme.of(context).textTheme.displaySmall?.apply(color: primaryColor),),
              Text(newPasswordWelcomeText2, style: Theme.of(context).textTheme.displayMedium?.apply(color: Colors.white),),
            ],
          ),
        )
      ],
